...
echo "optimal_run_counter data/tuples.bin 200000000"
RUNCOUNT=$(${ROOTDIR}/util/bin/optimal_run_counter ${ROOTDIR}/data/tuples.bin 200000000)

# Get optimal number of runs for anchor text.
echo "optimal_run_counter data/anchor_tuples.bin 200000000"
RUNCOUNT_ANCHOR=$(${ROOTDIR}/util/bin/optimal_run_counter ${ROOTDIR}/data/anchor_tuples.bin 200000000)
...
echo "ranking/bin/preprocess_ranking_data data/document_metadata.bin data/enhanced_document_metadata.bin data/index.bin data/anchor_index.bin"
${ROOTDIR}/ranking/bin/preprocess_ranking_data ${ROOTDIR}/data/document_metadata.bin ${ROOTDIR}/data/enhanced_document_metadata.bin ${ROOTDIR}/data/index.bin ${ROOTDIR}/data/anchor_index.bin
